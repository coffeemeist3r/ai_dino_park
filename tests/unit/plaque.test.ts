...
describe('zone indicator (BACKLOG-316)', () => {
  ...
  it('zoneTallyLine marks only the active zone with ▸ (all zones listed, BACKLOG-378)', () => {
    ...
    expect(line).toBe('Pocket Cretaceous 4 · ▸The Grove 2 · The Fernreach 0 · The Hollow 0 · The Sunward Ridge 0');
    expect(zoneTallyLine({ [BOWL_ID]: 4, [GROVE_ID]: 2 }, BOWL_ID)).toBe(
      '▸Pocket Cretaceous 4 · The Grove 2 · The Fernreach 0 · The Hollow 0 · The Sunward Ridge 0',
    );
  });
});
