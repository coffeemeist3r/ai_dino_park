...
- [ ] BACKLOG-493 [core] The day nobody can reach — the in-game day is 24 real hours at the default 1x clock, so every day-boundary system in the park is invisible in a normal session; raise the default and pay the ~10 specs it turns red (full text in the cycle-135 operator block below).
