...
- [ ] BACKLOG-508 [art] The black glass and the thing built from it — the Ridge's obsidian shard + the beacon raised from it, both shipping on the glyph fallback (full text in the cycle-142 block below).
