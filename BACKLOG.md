...
- [~] BACKLOG-528 [infra] The register can only see the first frame — every one of the ten reachability entries is a claim about a save that has just been created, and nothing in the park pins a claim about a save that has been *played* (full text in the cycle-149 block below).
