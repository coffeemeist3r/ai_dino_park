...
- [ ] BACKLOG-504 [core] The pile is a number in a menu — a ground's banked gathering drives upkeep, mends, ballots and the granary, and exists on screen only as a line inside the zone-map lens (full text in the cycle-140 block below).
