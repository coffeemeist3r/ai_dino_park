...
- [~] BACKLOG-503 [core] The branch with nothing to choose — the Ridge is the only ground reached by a *choice* rather than by walking the line, and nothing lives there or grows there that the line cannot supply (full text in the cycle-140 block below).
